...
number_choice_index1 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
number_choice_index1.grid(row=4, column=1, sticky=W, padx=5)
number_choice_index2 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
number_choice_index2.grid(row=4, column=1, sticky=E, padx=1)
number_choice_index3 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
number_choice_index3.grid(row=4, column=1)
number_choice_index4 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
number_choice_index4.grid(row=4, column=4, sticky=W, padx=12)
number_choice_index5 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
number_choice_index5.grid(row=4, column=5, sticky=W, padx=12)
number_choice_index6 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
number_choice_index6.grid(row=4, column=6, sticky=W, padx=12)
number_choice_index7 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
number_choice_index7.grid(row=4, column=7, sticky=W, padx=12)
number_choice_index8 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
number_choice_index8.grid(row=4, column=8, sticky=W, padx=12)
number_choice_index9 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
number_choice_index9.grid(row=4, column=9, sticky=W, padx=12)
number_choice_index10 = Entry(player_data_frame, width=3,validate='key', validatecommand=(vcmd, '%P'))
